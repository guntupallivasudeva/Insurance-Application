...
export class Home {
  ...
  insuranceProducts = [
    ...
    },
    {
      ...
      description: 'Drive with confidence knowing you\'re covered on the road.',
      icon: '<svg fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path></svg>'
    },
    {
  ...
  stats = [
    ...
    { number: '99%', label: 'Claims Approved' }
  ];
